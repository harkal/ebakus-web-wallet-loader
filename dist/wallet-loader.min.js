  ...
  function(t, e, n) {
    ...
    const c = {},
      ...
      l = t => {
        ...
        } else if ('withOverlay' === u) o.className += ' overlay'
        else if ('withoutOverlay' === u)
          o.className = o.className.replace(/\boverlay\b/, '')
        else if ('openInNewTab' === u && 'string' == typeof a)
    ...
    const f = t => s('init', t),
      p = t => s('unlockWallet', t),
      d = () => a('currentProviderEndpoint'),
      v = () => a('defaultAddress'),
      g = () => a('getBalance'),
      h = t => a('sendTransaction', t)
  },
])
