...
window.ebakusWallet = (function(t) {
      ...
      return [
        ...
        function(t, e) {
          ...
          for (var b, w = '', S = 0, E = 0; E < m.length; E++) {
            ...
            for (
              var _ = String(x[0]),
                O = s(l(c(x.index), p.length), 0),
                j = [],
                k = 1;
              k < x.length;
              k++
            )
              j.push(void 0 === (b = x[k]) ? b : String(b))
            var M = x.groups
            if (d) {
              var A = [_].concat(j, O, p)
              void 0 !== M && A.push(M)
              var P = String(e.apply(void 0, A))
            } else P = g(_, p, O, j, M, e)
  ...
  function(t, e, n) {
    t.exports = n(12)('native-function-to-string', Function.toString)
  },
  function(t, e, n) {
    var r = n(35)
    t.exports = function(t, e, n) {
  ...
  function(t, e, n) {
    n(1) &&
      'g' != /./g.flags &&
      n(15).f(RegExp.prototype, 'flags', { configurable: !0, get: n(8) })
  },
  function(t, e, n) {
    'use strict'
    n.r(e), n(16), n(36)
    ...
    const u = {},
      ...
      p = t => {
        ...
        if (n && u[n]) u[n](e)
          ...
          (o.className = o.className.replace(/\bactive\b/, '')),
            o.removeAttribute('style')
        else if ('resize' === c) {
          let t = ''
          const n = parseInt(e.width, 10),
            r = parseInt(e.height, 10)
          r > 60 && (t += 'height: '.concat(r, 'px;')),
            n > 150 && (t += 'width: '.concat(n, 'px;')),
            '' != t ? o.setAttribute('style', t) : o.removeAttribute('style')
        } else if ('withOverlay' === c) o.className += ' overlay'
        else if ('withoutOverlay' === c)
          o.className = o.className.replace(/\boverlay\b/, '')
        else if ('openInNewTab' === c && 'string' == typeof a)
    ...
    n.d(e, 'init', function() {
      ...
      n.d(e, 'isConnected', function() {
        return v
      }),
      n.d(e, 'unlockWallet', function() {
        return g
      }),
      n.d(e, 'getCurrentProviderEndpoint', function() {
        return h
      }),
      ...
      (() => {
        ...
        ;(t.className = 'ebakus-styles'),
          ...
          (() => {
            ...
            try {
              document.body.appendChild(t), (i = t.contentWindow)
            } catch (e) {
    ...
    const d = t => f('init', t),
      v = () => (() => c)(),
      g = t => f('unlockWallet', t),
      h = () => l('currentProviderEndpoint'),
      y = () => l('defaultAddress'),
      m = () => l('getBalance'),
      x = t => l('sendTransaction', t)
  },
])
